#!/usr/bin/env python3
"""
nscscc_perf/bitcount 性能瓶颈分析
- trace: /tmp/bitcount/simu_trace.txt
- 区间: get_count start(行52716) ~ stop(行359486)
- 反汇编: /tmp/bitcount/bitcount.dis
"""
import re
...
insn_info = {}
for line in open("/tmp/bitcount/bitcount.dis"):
...
# ---------- 解析 trace ----------
START_LINE, END_LINE = 52716, 359486
def parse(path):
    groups = []
    cur_ns = None; cur = []
    with open(path) as f:
