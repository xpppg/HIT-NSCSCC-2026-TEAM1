module fetch_buffer(
    ...
    output wire [34:0] id_pred_info_2,
...
wire [1:0] pred_pht_ID;
wire wb_ex_ID;
wire [5:0] wb_ecode_ID;
wire [8:0] wb_esubcode_ID;
wire pred_taken_ID2;
wire [31:0] pred_target_ID2;
wire [1:0] pred_pht_ID2;
wire wb_ex_ID2;
wire [5:0] wb_ecode_ID2;
wire [8:0] wb_esubcode_ID2;

assign {pred_pht_IF,pred_taken_IF,pred_target_IF} = if_pred_info;
assign {wb_esubcode_IF,wb_ecode_IF,wb_ex_IF} = if_ex_info;
assign {pred_pht_IF2,pred_taken_IF2,pred_target_IF2} = if_pred_info_2;
    ...
    if(flush) begin
        ...
        if(wr & !full) begin
            ...
            if(wr2) begin
                ...
                pred_pht[wr_ptr + 4'd1] <= pred_pht_IF2;
...
assign pred_pht_ID2 = pred_pht[rd_ptr + 4'd1];
...
assign id_pred_info_2 = {pred_pht_ID2, pred_taken_ID2, pred_target_ID2};
