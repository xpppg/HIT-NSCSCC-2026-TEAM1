...
// data_bram_way0 begin
    data_bram_bank bank0_way0(
        .clka(clk),
        .ena(1'b1),     // 1
        .wea(refresh?lru?4'b0000:4'b1111:write_back?4'b0000:sram_en&bank_sel[0]&hit[0]?sram_wen:4'b0000),     // 4
        .addra(index),   // 7
    ...
    data_bram_bank bank1_way0(
        .clka(clk),
        .ena(1'b1),     // 1
        .wea(refresh?lru?4'b0000:4'b1111:write_back?4'b0000:sram_en&bank_sel[1]&hit[0]?sram_wen:4'b0000),     // 4
        .addra(index),   // 7
    ...
    data_bram_bank bank2_way0(
        .clka(clk),
        .ena(1'b1),     // 1
        .wea(refresh?lru?4'b0000:4'b1111:write_back?4'b0000:sram_en&bank_sel[2]&hit[0]?sram_wen:4'b0000),     // 4
        .addra(index),   // 7
    ...
    data_bram_bank bank3_way0(
        .clka(clk),
        .ena(1'b1),     // 1
        .wea(refresh?lru?4'b0000:4'b1111:write_back?4'b0000:sram_en&bank_sel[3]&hit[0]?sram_wen:4'b0000),     // 4
        .addra(index),   // 7
    ...
    data_bram_bank bank4_way0(
        .clka(clk),
        .ena(1'b1),     // 1
        .wea(refresh?lru?4'b0000:4'b1111:write_back?4'b0000:sram_en&bank_sel[4]&hit[0]?sram_wen:4'b0000),     // 4
        .addra(index),   // 7
    ...
    data_bram_bank bank5_way0(
        .clka(clk),
        .ena(1'b1),     // 1
        .wea(refresh?lru?4'b0000:4'b1111:write_back?4'b0000:sram_en&bank_sel[5]&hit[0]?sram_wen:4'b0000),     // 4
        .addra(index),   // 7
    ...
    data_bram_bank bank6_way0(
        .clka(clk),
        .ena(1'b1),     // 1
        .wea(refresh?lru?4'b0000:4'b1111:write_back?4'b0000:sram_en&bank_sel[6]&hit[0]?sram_wen:4'b0000),     // 4
        .addra(index),   // 7
    ...
    data_bram_bank bank7_way0(
        .clka(clk),
        .ena(1'b1),     // 1
        .wea(refresh?lru?4'b0000:4'b1111:write_back?4'b0000:sram_en&bank_sel[7]&hit[0]?sram_wen:4'b0000),     // 4
        .addra(index),   // 7
    ...
    data_bram_bank bank8_way0(
        .clka(clk),
        .ena(1'b1),     // 1
        .wea(refresh?lru?4'b0000:4'b1111:write_back?4'b0000:sram_en&bank_sel[8]&hit[0]?sram_wen:4'b0000),     // 4
        .addra(index),   // 7
    ...
    data_bram_bank bank9_way0(
        .clka(clk),
        .ena(1'b1),     // 1
        .wea(refresh?lru?4'b0000:4'b1111:write_back?4'b0000:sram_en&bank_sel[9]&hit[0]?sram_wen:4'b0000),     // 4
        .addra(index),   // 7
    ...
    data_bram_bank bank10_way0(
        .clka(clk),
        .ena(1'b1),     // 1
        .wea(refresh?lru?4'b0000:4'b1111:write_back?4'b0000:sram_en&bank_sel[10]&hit[0]?sram_wen:4'b0000),     // 4
        .addra(index),   // 7
    ...
    data_bram_bank bank11_way0(
        .clka(clk),
        .ena(1'b1),     // 1
        .wea(refresh?lru?4'b0000:4'b1111:write_back?4'b0000:sram_en&bank_sel[11]&hit[0]?sram_wen:4'b0000),     // 4
        .addra(index),   // 7
    ...
    data_bram_bank bank12_way0(
        .clka(clk),
        .ena(1'b1),     // 1
        .wea(refresh?lru?4'b0000:4'b1111:write_back?4'b0000:sram_en&bank_sel[12]&hit[0]?sram_wen:4'b0000),     // 4
        .addra(index),   // 7
    ...
    data_bram_bank bank13_way0(
        .clka(clk),
        .ena(1'b1),     // 1
        .wea(refresh?lru?4'b0000:4'b1111:write_back?4'b0000:sram_en&bank_sel[13]&hit[0]?sram_wen:4'b0000),     // 4
        .addra(index),   // 7
    ...
    data_bram_bank bank14_way0(
        .clka(clk),
        .ena(1'b1),     // 1
        .wea(refresh?lru?4'b0000:4'b1111:write_back?4'b0000:sram_en&bank_sel[14]&hit[0]?sram_wen:4'b0000),     // 4
        .addra(index),   // 7
    ...
    data_bram_bank bank15_way0(
        .clka(clk),
        .ena(1'b1),     // 1
        .wea(refresh?lru?4'b0000:4'b1111:write_back?4'b0000:sram_en&bank_sel[15]&hit[0]?sram_wen:4'b0000),     // 4
        .addra(index),   // 7
...
// data_bram_way1 begin
    data_bram_bank bank0_way1(
        .clka(clk),
        .ena(1'b1),     // 1
        .wea(refresh?lru?4'b1111:4'b0000:write_back?4'b0000:sram_en&bank_sel[0]&hit[1]?sram_wen:4'b0000),     // 4
        .addra(index),   // 7
        .dina(refresh?cacheline_new[31:0]:sram_wdata),    // 32
    ...
    data_bram_bank bank1_way1(
        .clka(clk),
        .ena(1'b1),     // 1
        .wea(refresh?lru?4'b1111:4'b0000:write_back?4'b0000:sram_en&bank_sel[1]&hit[1]?sram_wen:4'b0000),     // 4
        .addra(index),   // 7
        .dina(refresh?cacheline_new[63:32]:sram_wdata),    // 32
    ...
    data_bram_bank bank2_way1(
        .clka(clk),
        .ena(1'b1),     // 1
        .wea(refresh?lru?4'b1111:4'b0000:write_back?4'b0000:sram_en&bank_sel[2]&hit[1]?sram_wen:4'b0000),     // 4
        .addra(index),   // 7
        .dina(refresh?cacheline_new[95:64]:sram_wdata),    // 32
    ...
    data_bram_bank bank3_way1(
        .clka(clk),
        .ena(1'b1),     // 1
        .wea(refresh?lru?4'b1111:4'b0000:write_back?4'b0000:sram_en&bank_sel[3]&hit[1]?sram_wen:4'b0000),     // 4
        .addra(index),   // 7
        .dina(refresh?cacheline_new[127:96]:sram_wdata),    // 32
    ...
    data_bram_bank bank4_way1(
        .clka(clk),
        .ena(1'b1),     // 1
        .wea(refresh?lru?4'b1111:4'b0000:write_back?4'b0000:sram_en&bank_sel[4]&hit[1]?sram_wen:4'b0000),     // 4
        .addra(index),   // 7
        .dina(refresh?cacheline_new[159:128]:sram_wdata),    // 32
    ...
    data_bram_bank bank5_way1(
        .clka(clk),
        .ena(1'b1),     // 1
        .wea(refresh?lru?4'b1111:4'b0000:write_back?4'b0000:sram_en&bank_sel[5]&hit[1]?sram_wen:4'b0000),     // 4
        .addra(index),   // 7
        .dina(refresh?cacheline_new[191:160]:sram_wdata),    // 32
    ...
    data_bram_bank bank6_way1(
        .clka(clk),
        .ena(1'b1),     // 1
        .wea(refresh?lru?4'b1111:4'b0000:write_back?4'b0000:sram_en&bank_sel[6]&hit[1]?sram_wen:4'b0000),     // 4
        .addra(index),   // 7
        .dina(refresh?cacheline_new[223:192]:sram_wdata),    // 32
    ...
    data_bram_bank bank7_way1(
        .clka(clk),
        .ena(1'b1),     // 1
        .wea(refresh?lru?4'b1111:4'b0000:write_back?4'b0000:sram_en&bank_sel[7]&hit[1]?sram_wen:4'b0000),     // 4
        .addra(index),   // 7
        .dina(refresh?cacheline_new[255:224]:sram_wdata),    // 32
    ...
    data_bram_bank bank8_way1(
        .clka(clk),
        .ena(1'b1),     // 1
        .wea(refresh?lru?4'b1111:4'b0000:write_back?4'b0000:sram_en&bank_sel[8]&hit[1]?sram_wen:4'b0000),     // 4
        .addra(index),   // 7
        .dina(refresh?cacheline_new[287:256]:sram_wdata),    // 32
    ...
    data_bram_bank bank9_way1(
        .clka(clk),
        .ena(1'b1),     // 1
        .wea(refresh?lru?4'b1111:4'b0000:write_back?4'b0000:sram_en&bank_sel[9]&hit[1]?sram_wen:4'b0000),     // 4
        .addra(index),   // 7
        .dina(refresh?cacheline_new[319:288]:sram_wdata),    // 32
    ...
    data_bram_bank bank10_way1(
        .clka(clk),
        .ena(1'b1),     // 1
        .wea(refresh?lru?4'b1111:4'b0000:write_back?4'b0000:sram_en&bank_sel[10]&hit[1]?sram_wen:4'b0000),     // 4
        .addra(index),   // 7
        .dina(refresh?cacheline_new[351:320]:sram_wdata),    // 32
    ...
    data_bram_bank bank11_way1(
        .clka(clk),
        .ena(1'b1),     // 1
        .wea(refresh?lru?4'b1111:4'b0000:write_back?4'b0000:sram_en&bank_sel[11]&hit[1]?sram_wen:4'b0000),     // 4
        .addra(index),   // 7
        .dina(refresh?cacheline_new[383:352]:sram_wdata),    // 32
    ...
    data_bram_bank bank12_way1(
        .clka(clk),
        .ena(1'b1),     // 1
        .wea(refresh?lru?4'b1111:4'b0000:write_back?4'b0000:sram_en&bank_sel[12]&hit[1]?sram_wen:4'b0000),     // 4
        .addra(index),   // 7
        .dina(refresh?cacheline_new[415:384]:sram_wdata),    // 32
    ...
    data_bram_bank bank13_way1(
        .clka(clk),
        .ena(1'b1),     // 1
        .wea(refresh?lru?4'b1111:4'b0000:write_back?4'b0000:sram_en&bank_sel[13]&hit[1]?sram_wen:4'b0000),     // 4
        .addra(index),   // 7
        .dina(refresh?cacheline_new[447:416]:sram_wdata),    // 32
    ...
    data_bram_bank bank14_way1(
        .clka(clk),
        .ena(1'b1),     // 1
        .wea(refresh?lru?4'b1111:4'b0000:write_back?4'b0000:sram_en&bank_sel[14]&hit[1]?sram_wen:4'b0000),     // 4
        .addra(index),   // 7
        .dina(refresh?cacheline_new[479:448]:sram_wdata),    // 32
    ...
    data_bram_bank bank15_way1(
        .clka(clk),
        .ena(1'b1),     // 1
        .wea(refresh?lru?4'b1111:4'b0000:write_back?4'b0000:sram_en&bank_sel[15]&hit[1]?sram_wen:4'b0000),     // 4
        .addra(index),   // 7
        .dina(refresh?cacheline_new[511:480]:sram_wdata),    // 32
...
// data_bram_way1 end
    ...
    assign sram_rdata_way0 = ({32{bank_sel_r[0]}} & rdata_way0[0]) |
    ...
    assign sram_rdata_way1 = ({32{bank_sel_r[0]}} & rdata_way1[0]) |
