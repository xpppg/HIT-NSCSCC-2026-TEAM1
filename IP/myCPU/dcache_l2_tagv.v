...
module dcache_l2_tagv(
    ...
    always @(posedge clk) begin
        if (rst) begin
            ...
            if (alloc_way)
                tag_way1[index] <= {1'b1, alloc_dirty, tag_f};
            else
                tag_way0[index] <= {1'b1, alloc_dirty, tag_f};
        end
    end
