// =====================================================================
// dcache_l2_data.v
// 64KB 二级 D-Cache 数据阵列
//   - 2路 x 512组 x 512bit(64B), 即每路32KB
...
module dcache_l2_data(
    ...
    (* ram_style = "block" *) reg [511:0] mem_way0 [511:0];
    (* ram_style = "block" *) reg [511:0] mem_way1 [511:0];
