...
always @(posedge clk) begin
    if(reset)
        pred_buf_sel <= 1'b0;
    else if(~IF1_allowin & ~pred_buf_sel)
        pred_buf_sel <= 1'b1;
...
always @(posedge clk) begin
    ...
    begin
        pred_taken_buf <= pred_taken_pre_IF;
...
assign pred_taken_IF1 = pred_buf_sel ? pred_taken_buf : pred_taken_pre_IF;
...
assign sub_inst_valid_IF1 = sub_inst_valid_buf_IF1 & ~pred_taken_IF1;
